...
![The landing page's own step-by-step summary](images/pngs/landing.png){#fig-landing}
...
![Confirmed study selection, echoed back with phase/route/treatment before anything runs](images/pngs/Subset.png){#fig-subset}
...
![The Step 2 prompt](images/pngs/additional.png){#fig-additional}
...
![Fetching study data directly from an attached press release link](images/pngs/web_fetch.png){#fig-webfetch}
...
![Mapped rows shown for confirmation before anything is merged](images/pngs/preview_rows.png){#fig-previewrows}
...
![Manifest confirmed with all four studies -- the three from Step 1 plus the press-release addition](images/pngs/manifest.png){#fig-manifest}
...
![The skill's own chat summary immediately after fitting](images/pngs/summary.png){#fig-summary}

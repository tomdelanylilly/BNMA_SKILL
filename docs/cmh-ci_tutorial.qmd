...
process as a structured, end-to-end conversation.


## What `/cmh-ci` produces
...
- **Re-runnable `.Rmd`** — open in RStudio, run chunk-by-chunk to reproduce or modify
- **Pre-rendered `.html` report** — shareable immediately, no R needed to read
...
**Option B: Project-level** (works for everyone in that folder):
```
